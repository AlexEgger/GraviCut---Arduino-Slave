...
//     int positionenSchere[2] = {495, 80}; // Positionen für Schere
...
//     // requestValues[AnschlagModule] = 300;
//     // moduleStates[AnschlagModule] = RunningState;

//     // requestValues[SchieberModule] = 0;
//     // moduleStates[SchieberModule] = RunningState;

 
//     // requestValues[MagazinModule] = 3;
//     // moduleStates[MagazinModule] = RunningState;

//     // requestValues[WechslerModule] = 1;
//     // moduleStates[WechslerModule] = RunningState;
// }
...
//     // Module responder = SchieberModule;                           // Aktueller Funktionsblock
//     // moduleStates[responder] = modules[responder]->parseInput(0); // Funktion ausführen
// }
...
//                     Serial.print(moduleToString((Module)responder));
//                     Serial.print(F("  Status: "));
//                     Serial.println(moduleStates[responder]);
//                 }
...
//             currentAnschlag->parseInput(1); // Anschlag auf Ausweichposition fahren
//         }
//     }
